...
public class UserCreateRequest {
    ...
    public AccountType getProfileType() {
        return accountType;
    }

    public void setProfileType(AccountType profileType) {
        this.accountType = profileType;
    }

    // status getter and setter
    public com.burakkurucay.connex.entity.user.UserStatus getStatus() {
        return status;
    }

    public void setStatus(com.burakkurucay.connex.entity.user.UserStatus status) {
        this.status = status;
    }
}
